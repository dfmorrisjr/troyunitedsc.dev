...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8">
	<title>Official Website of Troy United Soccer Club - Join Our Club</title>

<?php include('../header.php') ?>
<!-- Begin Main Content -->
	<div class="sixteen columns maincontent row">
		<section class="joinourclub">
             ...
             <h5>Want to join our club?  Here is the equipment you will need.</h5>
             <ul>
				<li>Shin Guards</li>
             	<li>Cleats</li>
             ...
             <article class="fifteen columns">
                ...
                <h5>Below is the list of current fees.  Subject to change</h5>
                	<ul>
